...
CREATE TABLE `t_paper`  (
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '判断是否为在线出题、从试题库选题',
...
-- Records of t_paper
-- ----------------------------
INSERT INTO `t_paper` VALUES (2, '2018年秋季学期17级JavaEE期末考试题', '1');
INSERT INTO `t_paper` VALUES (3, '测试修改试卷', '0');
INSERT INTO `t_paper` VALUES (4, '测试', '0');
INSERT INTO `t_paper` VALUES (8, '测试增加试卷', '1');
INSERT INTO `t_paper` VALUES (9, 'test', NULL);
INSERT INTO `t_paper` VALUES (10, 'test2', NULL);
INSERT INTO `t_paper` VALUES (12, '2020年春季学期软件质量保证与测试考试', NULL);
INSERT INTO `t_paper` VALUES (19, 'test', NULL);
...
-- ----------------------------
INSERT INTO `t_paperdetail` VALUES (1, 2, 1, '程序中的语法错误可以在编译时立即发现？', '对', '错', '', '', '对', '2', '3', '判断题', 2);
